...
<table>
  <tr>
    <td><img src="https://github.com/nahollo/GMOVIE/assets/145747048/f6593289-fcc5-4a54-90a9-cfa9a94ba7b7" width="700" height="300" alt="시작 화면"></td>
    <td><img src="https://github.com/nahollo/GMOVIE/assets/145747048/065f6c28-e4e8-4613-a263-6a4e35ffd3f5" width="700" height="300" alt="화상회의 화면"></td>
  </tr>
  <tr>
    <td align="center">시작 화면</td>
    <td align="center">화상회의 화면</td>
  </tr>
</table>
...
GMOVIE는 실시간으로 회의를 진행하고 동시에 녹음하며, 자동으로 회의록을 작성하는 기능을 제공합니다. 더불어, 필요한 경우 회의록을 간략하게 요약하는 기능을 통해 사용자들은 불편함 없이 회의를 관리할 수 있게 됩니다. 또한, 작성된 회의록과 요약본은 워드 파일로 편집되어 사용자의 이메일로 전송되어 회의 후에도 중요한 자료를 확인하고 관리할 수 있습니다. 추가로, 화상 회의의 집중력 문제를 인식하고 중요한 내용을 놓치지 않도록 사용자를 지원합니다..<br>
