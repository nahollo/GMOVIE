...
// List<String> audioSegments = method.splitAudioInto20SecondSegments(fullFile,
// cutFiles);
...
// private static void convertTo16kHz(String inputFilePath, String
...
// public List<String> splitAudioInto20SecondSegments(String audioFilePath,
// String cutFiles) throws IOException {
...
// public String summarizeText(String client_id, String client_secret, String
...
// public static String translateText(String text, String sourceLang, String
// targetLang) {
...
// // API 요청 본문 설정
// String postData = "source=" + sourceLang + "&target=" + targetLang + "&text="
// + text;
...
// reader.close();
// Gson gson = new Gson();
// TranslationResponse translationResponse = gson.fromJson(response.toString(),
// TranslationResponse.class);
// String translatedText =
// translationResponse.getMessage().getResult().getTranslatedText();
