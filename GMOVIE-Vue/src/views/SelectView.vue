<template>
  <div class="container mt-3">
    ...
    <form>
      ...
      <div class="d-flex">
        <div class="p-2 flex-fill" v-if="result.gender == 1">
          <div class="form-check">
            <input type="radio" class="form-check-input" id="radio1" name="gender" v-bind:value="1" readonly v-model="result.gender" />
        ...
        <div class="p-2 flex-fill" v-else>
          <div class="form-check">
            <input type="radio" class="form-check-input" id="radio2" name="gender" v-bind:value="0" readonly v-model="result.gender" />
